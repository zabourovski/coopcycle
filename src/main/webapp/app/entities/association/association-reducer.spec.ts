...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSOCIATION actions', async () => {
      const expectedActions = [
        {
