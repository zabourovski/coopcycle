...
import glim.coopcycle.GlimApp;
import glim.coopcycle.config.AsyncSyncConfiguration;
import glim.coopcycle.config.EmbeddedSQL;
...
@SpringBootTest(classes = { GlimApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
