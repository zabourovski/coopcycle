...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("glim.coopcycle.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("glim.coopcycle.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
